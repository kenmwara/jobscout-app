...
export const BOX = 12;
export const R0 = 2.275;
export const DR = 0.2944;
...
/* The DISPLAY CUT. Computed from the true bbox (x −3.041…25.864,
   ...
   verbatim. */
export const ROSE_VIEWBOX = '-4.2416 -3.0639 31.3054 31.3054';

/* Law: the number of lit dots IS the band. */
export const BAND_DOTS = Object.freeze({
  auto: 8,
  ping: 6,
  unsure: 5,
  near: 3,
 ...
 * @returns {SVGElement}
 */
export function createRose(size = 52) {
...
export function roseMarkup(size = 52) {
 ...
 */
export function lightRose(card, next = {}) {
 ...
 */
export function scoreCard(card, score, band = bandFor(score)) {
