/* SITE COPY of the field-and-bar pack (Chat, 2026-09-21). */
/* ===========================================================================
...
/* classic script for the site and the mockup: enhance on load, and again for
   any field a re-render inserts later (the mockup paints whole screens) */
window.enhanceFields = enhanceFields;
if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', () => enhanceFields());
else enhanceFields();
new MutationObserver(muts => { for (const m of muts) for (const n of m.addedNodes) if (n.nodeType === 1 && (n.matches('.field') || n.querySelector('.field'))) { enhanceFields(n.parentElement || document); return; } })
